...
x1=`cat /sys/bus/hid/devices/0044:8086:22D8.000$d/HID-SENSOR-200041.*.auto/iio:device$f/name`
echo "/sys/bus/hid/devices/0044:8086:22D8.000$d/HID-SENSOR-200041.*.auto/iio:device$f/name=$x1"
