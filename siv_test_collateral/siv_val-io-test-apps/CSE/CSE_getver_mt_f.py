...
parser.add_argument('-t', help='test_name (getver_mt_f)')
...
def getver_mt_f(test_name):
    if test_name == "getver_mt_f":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "echo 'Errno' > /home/CSE_CONSOLE/getver_mt_f_console.log"
        test_to_execute3 = "python "+ test_script_location +"getver_mt.py -f &> /home/CSE_CONSOLE/getver_mt_f_console.log"
        test_to_execute4 = "dmesg > /home/CSE_CONSOLE/getver_mt_f_dmesg.log"
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/getver_mt_f_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/getver_mt_f_console.log")
        getver_mt_f(test_name)
        if test_name == "getver_mt_f":
                final_result = check()
