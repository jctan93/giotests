...
parser.add_argument('-t', help='test_name (getver)')
...
def getver(test_name):
    if test_name == "getver":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "python getver.py &> /home/CSE_CONSOLE/getver_console.log"
        test_to_execute3 = "dmesg > /home/CSE_CONSOLE/getver_dmesg.log"
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/getver_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/getver_console.log")
        getver(test_name)
        if test_name == "getver":
                final_result = check()
