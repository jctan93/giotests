...
parser.add_argument('-t', help='test_name (getver2)')
...
def getver2(test_name):
    if test_name == "getver2":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "python getver2.py &> /home/CSE_CONSOLE/getver2_console.log"
        test_to_execute3 = "dmesg > /home/CSE_CONSOLE/getver2_dmesg.log"
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/getver2_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/getver2_console.log")
        getver2(test_name)
        if test_name == "getver2":
                final_result = check()
