...
parser.add_argument('-t', help='test_name (getver_ut)')
...
def getver_ut(test_name):
    if test_name == "getver_ut":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "python "+ test_script_location +"getver_ut.py &> /home/CSE_CONSOLE/getver_ut_console.log"
        test_to_execute3 = "dmesg > /home/CSE_CONSOLE/getver_ut_dmesg.log"
...
def check():
    result = "FAIL"
    log_data1=open("/home/CSE_CONSOLE/getver_ut_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/getver_ut_console.log")
        getver_ut(test_name)
        if test_name == "getver_ut":
                final_result = check()
