...
parser.add_argument('-t', help='test_name (getver_mt_s)')
...
def getver_mt_s(test_name):
    if test_name == "getver_mt_s":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "echo 'Errno' > /home/CSE_CONSOLE/getver_mt_s_console.log"
        test_to_execute3 = "python "+ test_script_location + "getver_mt.py -s &> /home/CSE_CONSOLE/getver_mt_s_console.log"
        test_to_execute4 = "dmesg > /home/CSE_CONSOLE/getver_mt_s_dmesg.log"
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/getver_mt_s_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/getver_mt_s_console.log")
        getver_mt_s(test_name)
        if test_name == "getver_mt_s":
                final_result = check()
