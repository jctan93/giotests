...
parser.add_argument('-t', help='test_name (getver_mt_b)')
...
def getver_mt_b(test_name):
    if test_name == "getver_mt_b":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "echo 'Errno' > /home/CSE_CONSOLE/getver_mt_b_console.log"
        test_to_execute3 = "python " + test_script_location + "getver_mt.py -b &> /home/CSE_CONSOLE/getver_mt_b_console.log"
        test_to_execute4 = "dmesg > /home/CSE_CONSOLE/getver_mt_b_dmesg.log"
        print "Executing : " + test_name
        print "Command : " + test_to_execute2
        os.system(test_to_execute1)
        os.system(test_to_execute2)
        print test_to_execute3
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/getver_mt_b_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/getver_mt_b_console.log")
        getver_mt_b(test_name)
        if test_name == "getver_mt_b":
                final_result = check()
