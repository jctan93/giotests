...
parser.add_argument('-t', help='test_name (stress_ver)')
...
def stress_ver(test_name):
    if test_name == "stress_ver":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "python stress_ver.py &> /home/CSE_CONSOLE/stress_ver_console.log"
        test_to_execute3 = "dmesg > /home/CSE_CONSOLE/stress_ver_dmesg.log"
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/stress_ver_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/stress_ver_console.log")
        stress_ver(test_name)
        if test_name == "stress_ver":
                final_result = check()
