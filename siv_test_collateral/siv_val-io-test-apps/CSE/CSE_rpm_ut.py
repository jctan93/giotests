...
parser.add_argument('-t', help='test_name (rpm_ut)')
...
def rpm_ut(test_name):
    if test_name == "rpm_ut":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute = "python rpm_ut.py &> /home/CSE_CONSOLE/rpm_ut_console.log"
...
def check():
    result = "PASS"
    log_data1=open("/home/CSE_CONSOLE/rpm_ut_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/rpm_ut_console.log")
        rpm_ut(test_name)
        if test_name == "rpm_ut":
                final_result = check()
