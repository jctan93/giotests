...
parser.add_argument('-t', help='test_name (opencnt)')
...
def opencnt(test_name):
    if test_name == "opencnt":   
        print "TESTING FOR : ---------- " + test_name + " ---------- "
        test_to_execute1 = "dmesg -c"
        test_to_execute2 = "python "+ test_script_location +"opencnt.py &> /home/CSE_CONSOLE/opencnt_console.log"
        test_to_execute3 = "dmesg > /home/CSE_CONSOLE/opencnt_dmesg.log"
...
def check():
    result = "FAIL"
    log_data1=open("/home/CSE_CONSOLE/opencnt_console.log")
...
def main (test_name):
        ...
        #os.system("echo 0 >/home/CSE_CONSOLE/opencnt_console.log")
        opencnt(test_name)
        if test_name == "opencnt":
                final_result = check()
