...
/home/siv_test_collateral/siv_val-io-test-apps/IPU/sw_val/bin/media-ctl -l "\"Intel IPU4 CSI-2 0\":1 -> \"Intel IPU4 CSI-2 0 capture 0\":0[1]" -v

DEV_NAME=`/home/siv_test_collateral/siv_val-io-test-apps/IPU/sw_val/bin/media-ctl -e "Intel IPU4 CSI-2 0 capture 0"`
